...
#let kwd(
  accession-number: sym.space,
  identification-number: sym.space,
  document-type: sym.space,
  type-of-record: sym.space,
  contents-code: sym.space,
  author: (name: sym.space),
  mentor: (name: sym.space),
  title: sym.space,
  text-lang: sym.space,
  abstract-lang: sym.space,
  publication: (
    publisher: sym.space,
    country: sym.space,
    locality: sym.space,
  ...
  physical: auto,
  field: sym.space,
  discipline: sym.space,
  subject-keywords: sym.space,
  uc: sym.space,
  holding-data: sym.space,
  note: sym.space,
  abstract: sym.space,
  accepted-date: sym.space,
  defense: (
    date: sym.space,
    president: sym.space,
    member1: sym.space,
